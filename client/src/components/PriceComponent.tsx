...
const PriceComponent = () => {
  ...
  return (
    <div>
      <input onChange={handleChange} type="text" className="w-300  p-2 border rounded bg-pbr-purple text-left prompt-description draggable ng-pristine ng-valid ng-touched" id="name" name="name" required /><br />
